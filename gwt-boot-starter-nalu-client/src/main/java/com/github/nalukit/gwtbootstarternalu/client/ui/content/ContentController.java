...
public class ContentController
  ...
  public void start() {
    this.eventBus.addHandler(FlushProjectEvent.TYPE,
                             e -> {
                               boolean validApplicationData = this.<ApplicationComposite>getComposite("ApplicationMetaData")
                                                                  .flush();
                               boolean validProjectData = this.<ProjectComposite>getComposite("ProjectMetaData")
                                                              .flush();
                               boolean validScreensData = this.<ScreenComposite>getComposite("ScreenMetaData")
                                                              .flush();
    ...
    this.<ApplicationComposite>getComposite("ApplicationMetaData")
        .edit();
    this.<ProjectComposite>getComposite("ProjectMetaData")
        .edit();
    this.<ScreenComposite>getComposite("ScreenMetaData")
        .edit();
  }
