...
public class ProjectCompositeComponent
    extends AbstractCompositeComponent<IProjectCompositeComponent.Controller, HTMLElement>
    implements IProjectCompositeComponent {

  private final FieldsGrouping               grouping = FieldsGrouping.create();
  ...
  public void render() {
    ...
    serverImplementationSelect = Select.<ServerImplementation>create("Server Implementation")
                                       .appendChild(SelectOption.create(ServerImplementation.GWT_MAVEN_PLUGIN,
