...
import com.github.nalukit.gwtbootstarternalu.client.ui.content.composite.project.IProjectCompositeComponent.Controller;
...
public class ProjectCompositeComponent
  ...
  public void render() {
    ...
    artifactIdTextBox = TextBox.create("Artifact ID")
                               ...
                               .value("MyTestProject")
                               .floating()
                               .addLeftAddOn(Icons.ALL.archive())
                               .groupBy(grouping);
    ...
    widgetSetSelect = Select.<WidgetLibrary>create("Widget Set").appendChild(SelectOption.create(WidgetLibrary.DOMINO_UI,
                                                                ...
                                                                .selectAt(3)
                                                                .addLeftAddOn(Icons.ALL.dashboard())
                                                                .groupBy(grouping);
