...
public class ProjectComponent
  ...
  public void render() {
    ...
    mavenSettingsSelect = Select.<MavenModule>create("Maven").appendChild(SelectOption.create(MavenModule.SINGLE_MAVEN_MODULE,
                                                             ...
                                                             .appendChild(SelectOption.create(MavenModule.MULTI_MAVEN_MODULE,
  ...
  public void edit(NaluGeneraterParms naluGeneraterParms) {
    this.mavenSettingsSelect.setValue(naluGeneraterParms.getMavenSettings());
  ...
  public NaluGeneraterParms flush(NaluGeneraterParms naluGeneraterParms) {
    naluGeneraterParms.setMavenSettings(this.mavenSettingsSelect.getValue());
