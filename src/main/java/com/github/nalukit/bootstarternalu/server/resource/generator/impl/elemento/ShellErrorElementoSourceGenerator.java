...
public class ShellErrorElementoSourceGenerator
    extends AbstractShellApplicationSourceGenerator {

  private ShellErrorElementoSourceGenerator(Builder builder) {
    super();
  ...
  public MethodSpec createRenderMethod() {
    return MethodSpec.methodBuilder("render")
                     ...
                     .addStatement("return this.element.css(\"shell\")" +
                                   ...
                                   ".add($T.div().attr(\"id\", \"footer\").css(\"shellErrorFooter\").asElement())" +
                                   ".add($T.div().attr(\"id\", \"content\").css(\"shellErrorContent\").asElement())" +
                                   ".asElement()",
                                   Elements.class,
                                   Elements.class,
                                   Elements.class)
