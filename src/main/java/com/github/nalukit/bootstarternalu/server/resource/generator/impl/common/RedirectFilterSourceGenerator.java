...
import com.github.nalukit.bootstarternalu.server.resource.generator.impl.AbstractSourceGenerator;
...
public class RedirectFilterSourceGenerator
    extends AbstractSourceGenerator {

  private String clientPackageJavaServerConform;

  private RedirectFilterSourceGenerator(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public RedirectFilterSourceGenerator build() {
      return new RedirectFilterSourceGenerator(this);
    }
