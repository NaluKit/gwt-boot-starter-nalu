...
public class ShellLoginGwtSourceGenerator
    extends AbstractShellApplicationSourceGenerator {

  private ShellLoginGwtSourceGenerator(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public ShellLoginGwtSourceGenerator build() {
      return new ShellLoginGwtSourceGenerator(this);
    }
