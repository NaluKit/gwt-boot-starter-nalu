...
package com.github.nalukit.gwtbootstarternalu.server.service.generator.impl.gwt;
...
public class ControllerComponentGwtSourceGenerator
    extends AbstractControllerComponentSourceGenerator {

  private ControllerComponentGwtSourceGenerator(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public ControllerComponentGwtSourceGenerator build() {
      return new ControllerComponentGwtSourceGenerator(this);
    }
