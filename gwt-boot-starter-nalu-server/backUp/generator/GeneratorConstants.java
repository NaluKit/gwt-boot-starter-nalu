...
package com.github.nalukit.gwtbootstarternalu.server.service.generator;
...
public class GeneratorConstants {
  ...
  public final static String COPYRIGHT_JAVA = String.format("Copyright (C) 2018 - 2021 Frank Hossfeld <frank.hossfeld@googlemail.com>%n" +
                                                            "%n" +
