...
public class CssPageElementoGwtSourceGenerator {
  
  private NaluGeneraterParms naluGeneraterParms;
  private File               directoryWebapp;
  
  private CssPageElementoGwtSourceGenerator(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public CssPageElementoGwtSourceGenerator build() {
      return new CssPageElementoGwtSourceGenerator(this);
    }
