...
public class SpringBootApplicationSourceGenerator
        extends AbstractSourceGenerator {

    private SpringBootApplicationSourceGenerator(SpringBootApplicationSourceGenerator.Builder builder) {
        super();
    ...
    public static class Builder {
        ...
        public SpringBootApplicationSourceGenerator.Builder directoryJava(File directoryJava) {
            this.directoryJava = directoryJava;
            return this;
        }

        public SpringBootApplicationSourceGenerator.Builder serverPackageJavaConform(String serverPackageJavaConform) {
            this.serverPackageJavaConform = serverPackageJavaConform;
            return this;
        }

        public SpringBootApplicationSourceGenerator build() {
            return new SpringBootApplicationSourceGenerator(this);
        }
    }

    public static SpringBootApplicationSourceGenerator.Builder builder() {
        return new SpringBootApplicationSourceGenerator.Builder();
    }
}
