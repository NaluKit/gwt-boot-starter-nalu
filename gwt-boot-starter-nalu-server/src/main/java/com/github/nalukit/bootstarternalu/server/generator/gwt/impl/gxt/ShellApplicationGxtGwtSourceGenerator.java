...
public class ShellApplicationGxtGwtSourceGenerator
    extends AbstractShellApplicationGwtSourceGenerator {
  
  private ShellApplicationGxtGwtSourceGenerator(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public ShellApplicationGxtGwtSourceGenerator build() {
      return new ShellApplicationGxtGwtSourceGenerator(this);
    }
