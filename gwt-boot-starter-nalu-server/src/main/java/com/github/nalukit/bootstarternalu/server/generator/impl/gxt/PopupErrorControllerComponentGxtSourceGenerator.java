...
public class PopupErrorControllerComponentGxtSourceGenerator
    extends AbstractPopupErrorControllerComponentSourceGenerator {

  private PopupErrorControllerComponentGxtSourceGenerator(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public PopupErrorControllerComponentGxtSourceGenerator build() {
      return new PopupErrorControllerComponentGxtSourceGenerator(this);
    }
