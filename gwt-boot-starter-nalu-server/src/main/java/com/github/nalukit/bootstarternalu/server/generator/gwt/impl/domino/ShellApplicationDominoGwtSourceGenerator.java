...
public class ShellApplicationDominoGwtSourceGenerator
    extends AbstractShellApplicationGwtSourceGenerator {
  
  private ShellApplicationDominoGwtSourceGenerator(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public ShellApplicationDominoGwtSourceGenerator build() {
      return new ShellApplicationDominoGwtSourceGenerator(this);
    }
