...
public class ShellLoginElementoGwtSourceGenerator
    extends AbstractShellApplicationGwtSourceGenerator {
  
  private ShellLoginElementoGwtSourceGenerator(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public ShellLoginElementoGwtSourceGenerator build() {
      return new ShellLoginElementoGwtSourceGenerator(this);
    }
