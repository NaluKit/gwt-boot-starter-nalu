...
public class StatusBarGxtGwtSourceGenerator
    extends AbstractStatusBarGwtSourceGenerator {
  
  private StatusBarGxtGwtSourceGenerator(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public StatusBarGxtGwtSourceGenerator build() {
      return new StatusBarGxtGwtSourceGenerator(this);
    }
