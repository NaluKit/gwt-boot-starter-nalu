...
public class ShellErrorGwtSourceGenerator
    extends AbstractShellApplicationSourceGenerator {

  private ShellErrorGwtSourceGenerator(Builder builder) {
    super();
  ...
  protected MethodSpec createBindMethod() {
    return MethodSpec.methodBuilder("bind")
                     .addModifiers(Modifier.PUBLIC)
                     .addAnnotation(ClassName.get(Override.class))
                     .addStatement("$T<ErrorShell> provider = new ErrorShellSelectorProviderImpl()",
