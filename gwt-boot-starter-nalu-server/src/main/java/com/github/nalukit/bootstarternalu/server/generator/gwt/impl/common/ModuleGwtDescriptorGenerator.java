...
public class ModuleGwtDescriptorGenerator {
  
  private NaluGeneraterParms naluGeneraterParms;
  private String             projectFolder;
  
  private ModuleGwtDescriptorGenerator(Builder builder) {
    super();
  ...
  public void generate()
    ...
    freeMarkerConfiguration.setClassForTemplateLoading(ModuleGwtDescriptorGenerator.class,
                                                       "/templates/gwt/xml");
  ...
  public static class Builder {
    ...
    public ModuleGwtDescriptorGenerator build() {
      return new ModuleGwtDescriptorGenerator(this);
    }
