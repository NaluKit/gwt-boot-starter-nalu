  ...
  public void onEvent(ApplicationEvent applicationEvent) {
    switch (applicationEvent.getType()) {
      case INITIALIZATION_FINISHED:
        System.out.println("GwtBootStarterNalu Application {} was initialized." +
                           applicationEvent.getResourceConfig()
                                           .getApplicationName());
        break;
      case DESTROY_FINISHED:
        System.out.println("GwtBootStarterNalu Application {} was detroyed." +
                           applicationEvent.getResourceConfig()
                                           .getApplicationName());
        break;
      default:
      ...
      switch (requestEvent.getType()) {
        ...
        case RESOURCE_METHOD_FINISHED:
          ...
          final String resourceName = requestEvent.getUriInfo()
                                                  ...
                                                  .getHandlerClass()
                                                  .getName();
          System.out.println("GwtBootStarterNalu Application -> " + resourceName + ": Method '" + methodName + "' executed. Processing time: " + methodExecution + " ms");
          break;
        case ON_EXCEPTION:
          System.out.println("=====================================================================================================================================================");
        ...
        case EXCEPTION_MAPPING_FINISHED:
          System.out.println("GwtBootStarterNalu Application {} -> requestEvent.getType() >>" +
