...
public class HeaderElementoGwtSourceGenerator
    extends AbstractHeaderGwtSourceGenerator {
  
  private HeaderElementoGwtSourceGenerator(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public HeaderElementoGwtSourceGenerator build() {
      return new HeaderElementoGwtSourceGenerator(this);
    }
