...
public class GwtHeaderGxtGwtSourceGenerator
    extends AbstractHeaderGwtSourceGenerator {
  
  private GwtHeaderGxtGwtSourceGenerator(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public GwtHeaderGxtGwtSourceGenerator build() {
      return new GwtHeaderGxtGwtSourceGenerator(this);
    }
