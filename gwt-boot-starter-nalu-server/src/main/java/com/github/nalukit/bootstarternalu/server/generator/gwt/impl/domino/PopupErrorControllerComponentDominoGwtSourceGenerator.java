...
public class PopupErrorControllerComponentDominoGwtSourceGenerator
    extends AbstractPopupErrorControllerComponentGwtSourceGenerator {
  
  private PopupErrorControllerComponentDominoGwtSourceGenerator(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public PopupErrorControllerComponentDominoGwtSourceGenerator build() {
      return new PopupErrorControllerComponentDominoGwtSourceGenerator(this);
    }
