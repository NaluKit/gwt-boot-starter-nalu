...
public class HostPageGwtSourceGenerator {
  
  private NaluGeneraterParms naluGeneraterParms;
  private File               directory;
  
  private HostPageGwtSourceGenerator(Builder builder) {
    super();
  ...
  private void generateHostPage()
    ...
    freeMarkerConfiguration.setClassForTemplateLoading(HostPageGwtSourceGenerator.class,
                                                       "/templates/gwt/html");
  ...
  public static class Builder {
    ...
    public HostPageGwtSourceGenerator build() {
      return new HostPageGwtSourceGenerator(this);
    }
